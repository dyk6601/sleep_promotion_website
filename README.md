...
## Project Structure
- `src/app/quiz` — Quiz pages and logic
- `src/app/scales` — Sleep rating scales
- `src/app/tracker` — Sleep tracker
- `src/app/education` — Educational content hub
- `src/app/achievements.tsx` — Achievements system
- `src/app/ai-program` — AI sleep program
## Learn More
